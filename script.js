document.addEventListener('DOMContentLoaded', () => {
  ...
  function updateCart(){
    ...
    carrello.forEach(item=>{const t=item.tipo.toLowerCase();let c=t.includes('lead')?1:t.includes('appuntamento')?2:0;sum+=c*40;
  ...
  elems.btnLogin.onclick=()=>{
    ...
    if(e&&p){loggedIn=true;alert('Login successful!');elems.payModal.style.display='none';}
    else alert('Inserisci credenziali valide.');
  };
