document.addEventListener('DOMContentLoaded', () => {
  ...
  elems.btnLogin.onclick = () => { alert('Login process is to be implemented!'); };
  elems.btnRegister.onclick = () => { alert('Registration process is to be implemented!'); };
  elems.btnRecoverPassword.onclick = () => { alert('Password recovery process is to be implemented!'); };
